...
public class ConnectFourDriver {
    ...
    public static void main(String[] args) {
        ...
        ConnectFour game2 = new ConnectFour(6, 7); // horizontal game, player 0 win
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (game2.isLastDropConnectFour()) {
        ...
        int x = 3;
        ConnectFour game3 = new ConnectFour(6, 7); //checking row connect 4
        game3.setPlayerTokens(Token.RED, Token.BLUE);
        ...
        if (game3.isLastDropConnectFour()) {

            System.out.println("passed vertical test");

        }
        game3.printGrid();

        int y = 0;
        ConnectFour game4 = new ConnectFour(8, 8); //another connect 4 check to view game
        game4.setPlayerTokens(Token.RED, Token.BLUE);
        ...
        for (int i = 2; i < 8; i++) {
            ...
            for (int j = 2; j < 8; j++) {
                ...
                game4.printGrid();
                if (game4.isLastDropConnectFour()) {
